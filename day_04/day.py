...
def engine_part_1(lines: List[str]):
    total_pairs = 0
    for line in lines:
        pair_one_min, pair_one_max, pair_two_min, pair_two_max = _get_pairs_min_max(
            line
        )
        pair_one_in_pair_two = (
            pair_one_min >= pair_two_min and pair_one_max <= pair_two_max
        )
        pair_two_in_pair_one = (
            pair_two_min >= pair_one_min and pair_two_max <= pair_one_max
        )
...
def engine_part_2(lines: List[str]):
    ...
    for line in lines:
        ...
        if (
            pair_one_min_overlap
            or pair_one_max_overlap
            or pair_two_min_overlap
            or pair_two_max_overlap
        ):
            total_pairs += 1
    return total_pairs


def _get_pairs_min_max(line: str):
    ...
    return pair_one_min, pair_one_max, pair_two_min, pair_two_max
